...
export default function Footer() {
  ...
  return (
    <footer ref={footerRef} className="bg-navy border-t border-white/5">
      <div className="max-w-6xl mx-auto px-6 lg:px-8 py-14 lg:py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-10 mb-12">
          ...
          {/* Brand */}
          <div className="footer-col col-span-2 md:col-span-1 opacity-0">
            <div className="flex items-center gap-2.5 mb-4">
              ...
              <span className="font-bold text-white text-base tracking-tight">{COMPANY.name}</span>
            </div>
          ...
          <div className="footer-col opacity-0">
            <p className="text-white/30 text-xs font-semibold uppercase tracking-wider mb-4">Navigation</p>
          ...
          {/* Services */}
          <div className="footer-col opacity-0">
            <p className="text-white/30 text-xs font-semibold uppercase tracking-wider mb-4">Services</p>
            <ul className="space-y-2.5">
              {SERVICE_VERTICALS.map((s) => (
                <li key={s.id}>
                  <a href="#services" className="text-white/55 hover:text-white text-sm transition-colors">
                    {s.title}
                  </a>
                </li>
              ))}
          ...
          {/* Contact */}
          <div className="footer-col opacity-0">
            <p className="text-white/30 text-xs font-semibold uppercase tracking-wider mb-4">Contact</p>
            <ul className="space-y-2.5">
              <li>
                <a href={`mailto:${COMPANY.email}`} className="text-white/55 hover:text-white text-sm transition-colors">
                  {COMPANY.email}
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-white/8 pt-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          <p className="text-white/25 text-xs">© {currentYear} {COMPANY.name}. All rights reserved.</p>
          <p className="text-white/20 text-xs">North Macedonia · Serving Nordic &amp; Benelux markets</p>
        </div>
